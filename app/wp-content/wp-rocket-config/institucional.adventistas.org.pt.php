...
$rocket_cookie_hash = '82b738c1c460b0eb817e1d3e667eacde';
$rocket_logged_in_cookie = 'wordpress_logged_in_82b738c1c460b0eb817e1d3e667eacde';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/pt/documentos-e-declaracoes-oficiais/|/pt/nossas-crencas/|/pt/nossas-crencas/(.*)/|/pt/documentos/(.*)/|/pt/voce-precisa-saber/(.*)/|/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|http://(/%5B/%5D+)?/(index.php/)?(.*)wp-json(/.*|$)';
...
$rocket_secret_cache_key = '652595d4adc7b963861895';
$rocket_cache_ssl = 1;

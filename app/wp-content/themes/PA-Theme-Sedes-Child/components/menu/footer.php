      ...
      <div class="col d-flex flex-column justify-content-xl-between">
        <div class="d-flex flex-column align-items-center align-items-xl-start px-5 px-xl-0">
          <?php if(!empty($campo) && !is_wp_error($campo)): ?>
            <div class="pa-brand">
              <a href="/" title="<?= !empty($campo->name) ? $campo->name : '' ?>" class="d-flex flex-column justify-content-center teste">
                <img src="/pt/wp-content/uploads/sites/3/2023/10/logo.svg" alt="<?= $campo->name ?>" title="<?= $campo->name ?>" class="img-fluid">
              </a>
